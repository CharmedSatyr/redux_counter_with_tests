# Redux Counter With Tests

A big-boned React + Redux Counter app with full test suites.

This project can serve as boilerplate for more comprehensive projects.
